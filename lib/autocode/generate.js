...
(function() {
  var colors, crypto, crystal, cson, error, extend, findVersions, force, fs, generate, handlebars, inject, loadModules, loadOutputs, loadProcessor, loadSchemaRefs, loaded_modules, merge, mkdirp, mustache, parse, path, processModules, readdir, request, season, semver, skeemas, sortObject, userHome, yaml;
