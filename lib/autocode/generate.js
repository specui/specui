...
(function() {
  var colors, crypto, crystal, cwd, error, extend, force, fs, generate, imports, inject, loadModules, loadOutputs, loadProcessor, loadSchemaRefs, loaded_modules, mkdirp, parse, path, processModules, readdir, request, requireFromString, semver, skeemas, sortObject, userHome, yaml;
