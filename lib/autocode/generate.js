...
(function() {
  var colors, crypto, crystal, cson, cwd, error, extend, findVersions, force, fs, generate, handlebars, imports, inject, loadModules, loadOutputs, loadProcessor, loadSchemaRefs, loaded_modules, merge, mkdirp, mustache, parse, path, processModules, readdir, request, requireFromString, season, semver, skeemas, sortObject, userHome, yaml;
