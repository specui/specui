...
(function() {
  var fs, install, mkdirp, path, request, semver, untar, userHome, zlib;
  ...
  install = function(opts) {
    var access_token_url, config_resp, config_url, crystal, headers, host, j, len, module_name, module_parse, module_path, module_version, release, release_resp, release_url, release_version, releases, tag_name, tarball, tarball_response, tarball_url;
    crystal = this;
    host = 'github.com';
