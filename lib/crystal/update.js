...
(function() {
  var error, fs, gunzip, mkdirp, request, semver, tarfs, untar, update, userHome, version, zlib;
  ...
  update = function() {
    var config, crystal, j, len, loadModules, loaded_modules, modules, path, submodule, submodules;
    crystal = this;
